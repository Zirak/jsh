...
var InjectedScriptHost = {
    eval : function (code) {
        /*jshint -W067*/
        // the above stops jshint from complaining about indirect eval.
        return (':(', eval)(code);
    },

    evaluateWithExceptionDetails : function (code) {
        /*jshint -W061*/
        // the above stops jshint from complaining about eval.
        return {
            result : InjectedScriptHost.eval(code),
